...
//GEN-HEADEREND:BeanDescriptor
        ...
        beanDescriptor = new BeanDescriptor  ( beans.led.Led.class , null );
...
//GEN-HEADEREND:Properties
        ...
        try {
            properties[PROPERTY_eingeschaltet] = new PropertyDescriptor ( "eingeschaltet", beans.led.Led.class, "isEingeschaltet", "setEingeschaltet" ); // NOI18N
            properties[PROPERTY_farbe] = new PropertyDescriptor ( "farbe", beans.led.Led.class, "getFarbe", "setFarbe" ); // NOI18N
        }
...
//GEN-HEADEREND:Events
        ...
        try {
            eventSets[EVENT_ledListener] = new EventSetDescriptor ( beans.led.Led.class, "ledListener", beans.led.LedListener.class, new String[] {"ledStateChanged"}, "addLedListener", "removeLedListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( beans.led.Led.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( beans.led.Led.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
        }                  
