 ...
 * @author duchu
 */
public class DigitBeanInfo extends SimpleBeanInfo {
...
//GEN-HEADEREND:BeanDescriptor
        ...
        beanDescriptor = new BeanDescriptor  ( beans.digit.Digit.class , null );
...
//GEN-HEADEREND:Properties
        ...
        try{
            properties[PROPERTY_value] = new PropertyDescriptor ( "Value", beans.digit.Digit.class, "getValue", "setValue" );
            properties[PROPERTY_index] = new PropertyDescriptor ( "Index", beans.digit.Digit.class, "getIndex", "setIndex" );
        }
    ...
    private static final int EVENT_digitListener = 0;
...
//GEN-HEADEREND:Events
        ...
        try{
            eventSets[EVENT_digitListener] = new EventSetDescriptor(beans.digit.Digit.class, "digitListener", beans.digit.DigitListener.class, new String[] {"valueChanged"}, "addDigitListener", "removeDigitListener");
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor(beans.digit.Digit.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener");
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
        }        
