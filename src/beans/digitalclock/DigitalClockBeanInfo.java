...
//GEN-HEADEREND:BeanDescriptor
        ...
        beanDescriptor = new BeanDescriptor  ( beans.digitalclock.DigitalClock.class , null );
         return beanDescriptor;     }//GEN-LAST:BeanDescriptor

    private static final int PROPERTY_hour = 0;
    private static final int PROPERTY_minute = 1;
...
//GEN-HEADEREND:Properties
        ...
        try{
            properties[PROPERTY_hour] = new PropertyDescriptor("Hour",beans.digitalclock.DigitalClock.class,"getHour","setHour");
            properties[PROPERTY_minute] = new PropertyDescriptor("Minute",beans.digitalclock.DigitalClock.class,"getMinute","setMinute");
            properties[PROPERTY_second] = new PropertyDescriptor("Second",beans.digitalclock.DigitalClock.class,"getSecond","setSecond");
        }
    ...
    private static final int EVENT_digitalClockListener = 0;
...
//GEN-HEADEREND:Events
        ...
        try{
            eventSets[EVENT_digitalClockListener] = new EventSetDescriptor(beans.digitalclock.DigitalClock.class, "digitalClockListener", beans.digitalclock.DigitalClockListener.class, new String[] {"timeChanged"}, "addDigitalClockListener", "removeDigitalClockListener");
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor(beans.digitalclock.DigitalClock.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener");
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
        }        
